 ...
 *
 * <p>Spring AI의 ChatClient를 사용하지 않고 Google SDK의 Client를
 * 통해 Gemini에 프롬프트를 전달합니다.</p>
 */
@Component
public class GeminiClient implements DispatchDeadlineAiClient {
    ...
    /**
     * Gemini API에 프롬프트를 직접 전달하여 발송 시한을 계산합니다.
     *
     * @param prompt Gemini에 전달할 최종 프롬프트
     * @return Gemini 실행 결과
     */
    @Override
    public AiExecutionResult calculateDispatchDeadline(
        String prompt
    ) {
