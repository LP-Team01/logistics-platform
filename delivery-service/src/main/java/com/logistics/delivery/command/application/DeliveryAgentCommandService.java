...
public class DeliveryAgentCommandService {
    ...
    public DeliveryAgentResponseDto create(CreateDeliveryAgentCommand command) {
        ...
        return DeliveryAgentResponseDto.from(saved);
    }

    public DeliveryAgentResponseDto update(UUID agentId, UpdateDeliveryAgentCommand command) {
