...
public enum ErrorCode {
    ...
    DELIVERY_ROUTE_RECORD_FORBIDDEN(HttpStatus.FORBIDDEN, "DELIVERY_403_03", "본인이 배정된 경로만 조회할 수 있습니다."),
    COMPANY_ROUTE_RECORD_FORBIDDEN(HttpStatus.FORBIDDEN, "DELIVERY_403_04", "본인이 배정된 업체배송경로만 조회할 수 있습니다."),
